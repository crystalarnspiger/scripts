...
def search_sierra(api_key, api_secret, id_list):
    ...
    for sierra_id in id_list:
        ...
        results.append(requests.get(
            'https://catalog2.lib.utexas.edu:443/iii/sierra-api/v4/bibs/'
            '{0}?fields=id%2CupdatedDate%2CcreatedDate%2CdeletedDate%2C'
            'deleted%2Csuppressed%2Cavailable%2Clang%2Ctitle%2Cauthor%2C'
            'materialType%2CbibLevel%2CpublishYear%2CcatalogDate%2Ccountry%2C'
            'orders%2CnormTitle%2CnormAuthor%2Clocations%2C'
            'fixedFields%2CvarFields'.format(sierra_id),
            headers={
